...
const Registration = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    // Validate photo URL (optional, based on your requirements)
    if (photo === "") {
      return toast.error("Photo URL cannot be empty.");
    }
      ...
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white dark:bg-gray-800 rounded-lg shadow-lg  lg:max-w-4xl ">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <div className="flex justify-center mx-auto">
            <img className="w-auto h-7 sm:h-8" src="https://www.fixtronics.us/wp-content/uploads/2020/12/fixtronics-300x300.png" alt="" />
          </div>
